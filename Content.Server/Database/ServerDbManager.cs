...
namespace Content.Server.Database
{
    public interface IServerDbManager
    {
        ...
        Task<PlayerRecord?> GetPlayerRecordByHWID(TypedHwid? hwID, CancellationToken cancel = default);
    ...
    public sealed class ServerDbManager : IServerDbManager
    {
        ...
        public Task<PlayerRecord?> GetPlayerRecordByHWID(TypedHwid? hwID, CancellationToken cancel = default)
        {
            DbReadOpsMetric.Inc();
        ...
        {
            DbWriteOpsMetric.Inc();
            return RunDbCommand(() => _db.AddConnectionLogAsync(userId, userName, address, hwId, trust, denied, serverId, publicKey));
        }
